...
Flame and smoke detection dataset "Flame and Smoke Detection

Description
The flame and smoke detection dataset contains 9,860 labeled images, with categories including Fire and Smoke. It covers images of flames and smoke under different scenarios, suitable for fire early warning and monitoring detection. It can be used for training YOLOv8 and YOLO11 models. This data set is a dataset, and it does not include the trained model weights at present.
